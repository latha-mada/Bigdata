...
class MoveRawData(DataProcess):
    ...
    def move_raw_data(self):
        ...
        :return:
        """
        print("Starting to move the raw data from {} to {}".format(self.input_path, self.output_path))
        ...
        if file_list:
            ...
            print("there are no files in the input path. Waiting for 10sec")
...
class TestMoveRawData(object):
    ...
    @classmethod
    def setup_class(cls):
        cls.input_path = "/home/hduser/hadoop/app/Bigdata/nfl_data"
        cls.backup_path = "/home/hduser/hadoop/app/Bigdata/move_raw_backup"
        cls.output_path = '/home/hduser/hadoop/app/Bigdata/input'
